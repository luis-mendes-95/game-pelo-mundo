...
const mudar_seta_info = () => {
    if (informacao_num === 1) {
        ...
        setas_informacoes.style.top = '10%'; 
    ...
    if (informacao_num === 3) {
        ...
        setas_informacoes.style.left = '25%'; 
    }
    if (informacao_num === 4) {
        setas_informacoes.src = "./assets/setas_informacoes/informacao_04.png"
        setas_informacoes.style.top = '45%'; 
        setas_informacoes.style.left = '38%'; 
    }
    if (informacao_num === 5) {
    ...
    if (informacao_num === 6) {
        ...
        setas_informacoes.style.top = '35%'; 
        setas_informacoes.style.left = '60%'; 
    }
}
